...
// in readeck_app/test/ui/bookmarks/widget/reading_screen_test.dart.
...
/// A class which mocks [ReadingViewmodel].
///
/// See the documentation for Mockito's code generation for more information.
class MockReadingViewmodel extends _i1.Mock implements _i3.ReadingViewmodel {
  MockReadingViewmodel() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i2.Command<int, List<_i4.BookmarkDisplayModel>> get load =>
      (super.noSuchMethod(
        Invocation.getter(#load),
        returnValue: _FakeCommand_0<int, List<_i4.BookmarkDisplayModel>>(
          this,
          Invocation.getter(#load),
        ),
      ) as _i2.Command<int, List<_i4.BookmarkDisplayModel>>);

  @override
  _i2.Command<int, List<_i4.BookmarkDisplayModel>> get loadMore =>
      (super.noSuchMethod(
        Invocation.getter(#loadMore),
        returnValue: _FakeCommand_0<int, List<_i4.BookmarkDisplayModel>>(
          this,
          Invocation.getter(#loadMore),
        ),
  ...
  @override
  set load(_i2.Command<int, List<_i4.BookmarkDisplayModel>>? _load) =>
      super.noSuchMethod(
        Invocation.setter(
          #load,
          _load,
  ...
  @override
  set loadMore(_i2.Command<int, List<_i4.BookmarkDisplayModel>>? _loadMore) =>
      super.noSuchMethod(
        Invocation.setter(
          #loadMore,
          _loadMore,
